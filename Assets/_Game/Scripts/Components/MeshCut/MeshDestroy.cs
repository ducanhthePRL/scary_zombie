...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh(Vector3 start_position)
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            Vector3 start_position_fix = start_position + 0.75f * Vector3.up;
            parts[i].GameObject.GetComponent<Rigidbody>().AddForceAtPosition((transform.position-start_position_fix) * ExplodeForce, start_position_fix );
        }
    }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            GameObject.layer = LayerMask.NameToLayer("NotCollideWithEntity");
